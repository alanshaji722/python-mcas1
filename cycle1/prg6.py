...
for i in list1:
    z=z+i
print("sum of the values of list 1 is:",z)
for i in list2:
    c=c+i
print("sum of the values of list 2 is:",c)
if(z!=c):
    print("list sum is not same")
else:

    print("list sum is same")
for g in range(0,len(list1)):
    if list1[g] in list2:
        print(list1[g],"occur in both")